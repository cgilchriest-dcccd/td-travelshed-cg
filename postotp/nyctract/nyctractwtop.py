...
# resbk5=pd.read_csv(path+'nyctract/resbkop1.csv',dtype=str)
# tp=pd.read_csv(path+'nyctract/resbkop2.csv',dtype=str)
# resbk5=pd.merge(resbk5,tp,on='blockid',how='inner')
# resbk5.to_csv(path+'nyctract/resbkop5.csv',index=True)
resbk6=pd.read_csv(path+'nyctract/resbkop3.csv',dtype=str)
tp=pd.read_csv(path+'nyctract/resbkop4.csv',dtype=str)
resbk6=pd.merge(resbk6,tp,on='blockid',how='inner')
resbk6.to_csv(path+'nyctract/resbk6.csv',index=True)
